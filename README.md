...
<p><b>Operating Systems:</b> <br>
  ...
  <h1 style="text-align: center; font-weight: bold; font-size: 16pt;">Deployment and Configuration Steps</h1> </p> 
    ...
    <p> 
        ...
        <p>
          <img width="270" alt="image" src="https://github.com/user-attachments/assets/3ada21b7-1c18-43d2-a999-6138ed3dda3f">

        </p>
        <p><img width="359" alt="image" src="https://github.com/user-attachments/assets/e0c4b039-3013-4fcf-bedb-cf3043802b79"></p> <br>
